...
source [Lamp](http://Lamp.org) learning management system on
Azure. We do not work on Lamp itself here, instead we work upstream
as appropriate.
...
where to spend their time. For example:
  ...
  * Wontfix items are considered out of scope for this project.
    ...
    ways. Often this will mean contribution to Lamp itself or a
